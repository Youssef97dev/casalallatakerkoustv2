  ...
  return (
    <div id="hero" className="relative w-full h-screen">
      <div className="w-full h-full">
        <Image
          src="/images/casa-lalla-takerkoust-lakeside-wedding-ceremony-marrakech.webp"
          alt="Outdoor wedding ceremony setup at Casa Lalla Takerkoust terrace overlooking Lake Takerkoust and Atlas Mountains"
          title="Lakeside Wedding Ceremony Venue at Casa Lalla Takerkoust"
          width={1500}
          height={1500}
