...
const Hero = () => {
  return (
    <div id="hero" className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 w-full flex justify-center text-center items-center font-lora text-white text-[24px] italic leading-10 lg:text-[40px] lg:leading-15 px-2 lg:px-0">
