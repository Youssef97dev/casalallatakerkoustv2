...
const Loader = () => {
  const jsonLd = {
    ...
    name: "Agafay & Lake Takerkoust Activities — Casa Lalla Day Club",
    description:
      "The ultimate Marrakech day-out itinerary. Book Mykonos-style pool day passes, Agafay desert quad biking, Lake Takerkoust jet skiing, and sunset DJ lounge sessions.",
    url: "https://casalallatakerkoust.com/lalla-takerkoust-activities/", // <-- Hardcode exact URL
